...
<div className="container my-24 px-6 mx-auto">
  ...
  <section className="mb-32 text-gray-100 text-center lg:text-left">
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div className="mt-12 lg:mt-0">
          <h1 className="text-5xl font-bold tracking-tight leading-tight mb-12">
            The best offer <br /><span className="text-purple-600">for your business</span>
          </h1>
        ...
        <div className="mb-12 lg:mb-0">
          <div className="block rounded-lg shadow-lg bg-white px-6 py-12 md:px-12">
            <form>
              ...
              <input type="email"
                className="form-control block w-full px-3 py-1.5 mb-6 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-purple-600 focus:outline-none"
              ...
              <div className="form-check flex justify-center mb-6">
                <input
                  className="form-check-input text-purple-600 appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-purple-500 checked:border-purple-500 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
              ...
              <div className="text-center">
                <p className="mb-6 text-gray-700">or sign up with:</p>
              </div>
              <div className="flex justify-center">
                <a href="#!" role="button"
                  className="text-purple-500 hover:text-purple-700 focus:text-purple-700 action:text-purple-800 transition duration-200 ease-in-out">
                      {/* <!-- Facebook --> */}
